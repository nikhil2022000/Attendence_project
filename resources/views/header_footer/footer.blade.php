    ...
    <footer class="footer">
			...
			<div class="sidebar sidebar-right sidebar-animate">
				...
				<div class="">
					...
					<div class="list-group-item  align-items-center  border-bottom">
						<div class="d-flex">
							<span class="avatar avatar-lg brround me-3" style="background-image: url({{url('degine/assets/images/users/12.jpg')}})">
								<span class="avatar-status bg-green"></span>
							</span>
							<div class="mt-1">
								<a  href="javascript:void(0);" class="font-weight-semibold fs-16">Vinny<span class="text-muted font-weight-normal"> shared your post</span></a>
...
<!--Moment js-->
<script src="{{url('degine/plugins/moment/moment.js')}}"></script>
...
<!--Othercharts js-->
<script src="{{url('degine/plugins/othercharts/jquery.sparkline.min.js')}}"></script>

<!--Sidemenu js-->
<script src="{{url('degine/plugins/sidemenu/sidemenu.js')}}"></script>

<!-- P-scroll js-->
<script src="{{url('degine/plugins/p-scrollbar/p-scrollbar.js')}}"></script>
<script src="{{url('degine/plugins/p-scrollbar/p-scroll1.js')}}"></script>

<!--Sidebar js-->
<script src="{{url('degine/plugins/sidebar/sidebar.js')}}"></script>

<!-- Select2 js -->
<script src="{{url('degine/plugins/select2/select2.full.min.js')}}"></script>

<!-- INTERNAL Peitychart js-->
<script src="{{url('degine/plugins/peitychart/jquery.peity.min.js')}}"></script>
<script src="{{url('degine/plugins/peitychart/peitychart.init.js')}}"></script>


<!-- INTERNAL Apexchart js-->
<script src="{{url('degine/plugins/apexchart/apexcharts.js')}}"></script>

<!-- INTERNAL Vertical-scroll js-->
<script src="{{url('degine/plugins/vertical-scroll/jquery.bootstrap.newsbox.js')}}"></script>
<script src="{{url('degine/plugins/vertical-scroll/vertical-scroll.js')}}"></script>

<!-- INTERNAL  Datepicker js -->
<script src="{{url('degine/plugins/date-picker/jquery-ui.js')}}"></script>

<!-- INTERNAL Chart js -->
<script src="{{url('degine/plugins/chart/chart.bundle.js')}}"></script>
<script src="{{url('degine/plugins/chart/utils.js')}}"></script>

<!-- INTERNAL Timepicker js -->
<script src="{{url('degine/plugins/time-picker/jquery.timepicker.js')}}"></script>
<script src="{{url('degine/plugins/time-picker/toggles.min.js')}}"></script>

<!-- INTERNAL Chartjs rounded-barchart -->
<script src="{{url('degine/plugins/chart.min/chart.min.')}}'"></script>
<script src="{{url('degine/plugins/chart.min/rounded-barchart.js')}}"></script>

<!-- INTERNAL jQuery-countdowntimer js -->
<script src="{{url('degine/plugins/jQuery-countdowntimer/jQuery.countdownTimer.js')}}"></script>

<!--Sticky js -->
<script src="{{url('degine/js/sticky.js')}}"></script>

<!-- INTERNAL Index js-->
<script src="{{url('degine/js/index1.js')}}"></script>
<!-- INTERNAL Index js-->
<script src="{{url('degine/js/hr/hr-attview.js')}}"></script>

	<!-- INTERNAL Sweet alert js -->
	<script src="{{url('degine/plugins/sweet-alert/jquery.sweet-modal.min.js')}}"></script>
		<script src="{{url('degine/plugins/sweet-alert/sweetalert.min.js')}}"></script>
		<script src="{{url('degine/js/sweet-alert.js')}}"></script>
...
<!-- INTERNAL Data tables -->
		<script src="{{url('degine/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
		<script src="{{url('degine/plugins/datatable/js/dataTables.bootstrap5.js')}}"></script>
		<script src="{{url('degine/plugins/datatable/js/dataTables.buttons.min.js')}}"></script>
		<script src="{{url('degine/plugins/datatable/js/buttons.bootstrap5.min.js')}}"></script>
		<script src="{{url('degine/plugins/datatable/dataTables.responsive.min.js')}}"></script>
		<script src="{{url('degine/plugins/datatable/responsive.bootstrap5.min.js')}}"></script>
