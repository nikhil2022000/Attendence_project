								...
								<div class="mb-4">
									...
									<ul class="vertical-scroll">
										<li class="item">
											<div class="card p-4 ">
												<div class="d-flex">
													<img src="{{url('degine/images/users/16.jpg')}}" alt="img" class="avatar avatar-md bradius me-3">
										...
										<li class="item">
											<div class="card p-4 ">
												<div class="d-flex">
													<img src="{{url('degine/images/users/4.jpg')}}" alt="img" class="avatar avatar-md bradius me-3">
													<div class="me-3 mt-0 mt-sm-1 d-block">
													...
													<table class="table mb-0 text-nowrap">
														<tbody>
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{url('degine/images/users/16.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{url('degine/images/users/1.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{url('degine//images/users/4.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<img src="{{url('degine/images/users/8.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
															...
															<tr>
																<td>
																	<div class="d-flex">
																		<img src="{{url('degine/images/users/9.jpg')}}" alt="img" class="avatar avatar-md brround me-3">
																		<div class="me-3 mt-0 mt-sm-1 d-block">
																			<h6 class="mb-0">Kimberly Berry</h6>
																			<div class="clearfix"></div>
																			<small>Senior Prototyper</small>
														...
														<tbody>
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<div class="table_img brround bg-light me-3">
																			<img src="{{url('degine/images/photos/html.png')}}" alt="img" class=" bg-light brround">
																		</div>
																		<div class="me-3 mt-3 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<div class="table_img brround bg-light me-3">
																			<img src="{{url('degine/images/photos/jquery.png')}}" alt="img" class=" bg-light brround">
																		</div>
																		<div class="me-3 mt-3 d-block">
															...
															<tr class="border-bottom">
																<td>
																	<div class="d-flex">
																		<div class="table_img brround bg-light me-3">
																			<img src="{{url('degine/images/photos/vue.png')}}" alt="img" class=" bg-light brround">
																		</div>
																		<div class="me-3 mt-3 d-block">
